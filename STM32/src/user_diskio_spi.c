...
#define CS_HIGH()	{HAL_GPIO_WritePin(SD_SPI_SS_GPIO_Port, SD_SPI_SS_Pin, GPIO_PIN_SET);}
#define CS_LOW()	{HAL_GPIO_WritePin(SD_SPI_SS_GPIO_Port, SD_SPI_SS_Pin, GPIO_PIN_RESET);}
