...
static u8 rd(u16 addr) {
    if (addr < 0x1800) {
        ...
        printf("PPU/Peripherals/Audio read not currently implemented.\n");
        return 0;
    } else {
        // printf("Mapper read not currently implemented.\n");
...
static void wr(u16 addr, u8 data) {
    if (addr < 0x1800) {
        ...
        // PPU, Peripherals, audio...
        printf("PPU/Peripherals/Audio write not currently implemented.\n");
    } else {
        printf("Mapper write not currently implemented.\n");
        mapper_wr(addr, data);
    }
}
